...
import (
	...
	"github.com/tencent/goom/internal/argdump/impl/go124"
...
func PatchFuncPtr(originPtr uintptr, origFuncVal unsafe.Pointer, typ reflect.Type) (*patch.Guard, error) {
	return go124.PatchFuncPtr(originPtr, origFuncVal, typ)
}
