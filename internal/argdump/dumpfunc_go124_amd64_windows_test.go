...
func TestMakeDumpFunc_PrintsArgsAndReturnsZero_AMD64(t *testing.T) {
...
func TestUnitMakeDumpFunc_PrintsArgsAndReturnsZero_AMD64(t *testing.T) {
	TestMakeDumpFunc_PrintsArgsAndReturnsZero_AMD64(t)
}
