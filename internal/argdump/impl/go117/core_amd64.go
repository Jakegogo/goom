...
func (a abiDesc) addrOfArg(i int, t reflect.Type, frame unsafe.Pointer, regs *regArgs) (unsafe.Pointer, interface{}) {
...
func (a abiDesc) addrOfRet(i int, t reflect.Type, frame unsafe.Pointer, regs *regArgs) (unsafe.Pointer, interface{}) {
