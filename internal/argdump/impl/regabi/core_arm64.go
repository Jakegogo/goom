...
func MakeDumpFunc(typ reflect.Type) anyCompat {
...
func dumpPanic(v anyCompat, _ abijson.Options) {
	shared.DumpPanic(v)
}
...
func (a abiDesc) addrOfArg(i int, t reflect.Type, frame unsafe.Pointer, regs *regArgs) (unsafe.Pointer, anyCompat) {
...
func (a abiDesc) addrOfRet(i int, t reflect.Type, frame unsafe.Pointer, regs *regArgs) (unsafe.Pointer, anyCompat) {
