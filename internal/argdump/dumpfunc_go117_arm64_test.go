...
func TestMakeDumpFunc_PreGo124_PrintsArgsAndReturnsZero(t *testing.T) {
...
func TestUnitMakeDumpFunc_PreGo124_PrintsArgsAndReturnsZero(t *testing.T) {
	TestMakeDumpFunc_PreGo124_PrintsArgsAndReturnsZero(t)
}
