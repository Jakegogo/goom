...
import (
	...
	"github.com/tencent/goom/internal/argdump/impl/go118"
...
func PatchFuncPtr(originPtr uintptr, origFuncVal unsafe.Pointer, typ reflect.Type) (*patch.Guard, error) {
	return go118.PatchFuncPtr(originPtr, origFuncVal, typ)
}
