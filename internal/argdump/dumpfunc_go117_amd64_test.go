...
func TestMakeDumpFunc_PreGo124_PrintsArgsAndReturnsZero_AMD64(t *testing.T) {
...
func TestUnitMakeDumpFunc_PreGo124_PrintsArgsAndReturnsZero_AMD64(t *testing.T) {
	TestMakeDumpFunc_PreGo124_PrintsArgsAndReturnsZero_AMD64(t)
}
